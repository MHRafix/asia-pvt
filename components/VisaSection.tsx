...
const features = [
  {
    ...
    description: "We handle all paperwork and ensure your application is complete",
  },
  {
    icon: Clock,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 1, x: 0 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <p className="font-body text-muted-foreground text-lg mb-8">
              Navigate complex visa requirements with ease. Our expert team ensures your documentation is perfect and your application has the best chance of approval.
            </p>
            ...
            <div className="space-y-6 mb-8">
              {features.map((feature) => (
                <div key={feature.title} className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-display text-lg font-semibold text-foreground mb-1">{feature.title}</h4>
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-1">
                      <p className="font-body text-xs text-muted-foreground">{country.type}</p>
                      <p className="font-body text-sm text-primary font-medium">{country.processing}</p>
                    </div>
                  </CardContent>
                </Card>
              ))}
            ...
            <div className="mt-6 p-4 rounded-xl bg-card border border-border">
              <div className="flex items-center gap-3">
                ...
                <p className="font-body text-sm text-muted-foreground">
                  <span className="font-medium text-foreground">50+ Countries</span> — We assist with visa applications worldwide
                </p>
              </div>
            </div>
          </motion.div>
