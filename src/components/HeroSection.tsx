  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroImage} alt="Tropical paradise beach" className="w-full h-full object-cover" />
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-3xl">
          ...
          >
            Explore breathtaking destinations, create unforgettable memories, and let us handle every detail of your perfect vacation.
          </motion.p>
          ...
          >
            ...
            <Button variant="heroOutline" size="xl" onClick={() => navigate("/appointment")}>
              Plan Your Trip
            </Button>
          </motion.div>
        </div>
              ...
              {activeTab === "packages" ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {showDestDropdown && (
                      <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-xl shadow-elevated z-50 max-h-48 overflow-y-auto">
                        ...
                        {filteredDestinations.length === 0 && (
                          <p className="px-4 py-3 text-sm text-muted-foreground font-body">No destinations found</p>
                        )}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-muted">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-muted-foreground font-body">Travel Date</p>
                      <input
                        type="date"
                        value={travelDate}
                  ...
                  <Button variant="coral" className="h-full" onClick={handlePackageSearch}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {showCountryDropdown && (
                      <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-xl shadow-elevated z-50 max-h-48 overflow-y-auto">
                        ...
                        {filteredCountries.length === 0 && (
                          <p className="px-4 py-3 text-sm text-muted-foreground font-body">No countries found</p>
                        )}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-muted">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-muted-foreground font-body">Visa Type</p>
                      <select
                  ...
                  <Button variant="ocean" className="h-full" onClick={handleVisaSearch}>
                    <Search className="w-4 h-4" />
                    Check Requirements
                  </Button>
                </div>
